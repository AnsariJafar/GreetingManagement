using GreetingManagement.BusinessLogic.EF;
using System;
...
namespace GreetingManagement.BusinessLogic.Common
{
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        //The following variable is going to hold the EmployeeDBContext instance
        public GreetingContext _context = null;
        ...
        {
            this._context = new GreetingContext();
        ...
        //we are initializing the context object and table variable
        public GenericRepository(GreetingContext _context)
        {
